...
Feature: CC-1080:Create new reagent
    ...
    |nama|type|note|
    |Reagent 2|Antibiotic|Create Reagent 2 with Antibiotic|
    ...
    And there is "new" item "Reagent 2" created in table
    When user clicks on menu "Reagent"
    And user clicks on sub-menu "Culture Reagent"
    Then user is navigated to "Culture Reagent" page
    And there is "no new" item "Reagent 2" created in table