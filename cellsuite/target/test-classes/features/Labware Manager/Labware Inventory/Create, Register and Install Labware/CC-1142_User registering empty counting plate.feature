@CC-1142_User_registering_empty_counting_plate
Feature: CC-1142:User registering empty counting plate

    this feature to verify that system allow user to register empty Counting Plate to the system
    ...
    And "CP 24 Wells" items is "already" exist
    # And there is "Counting Plate" type Labware created on Labware Library
    And user clicks on sub-menu "Inventory"
    Then user is navigated to "Inventory" page

    Scenario: User registering empty counting plate
    When user clicks on "Register" button
    Then user is navigated to "Register Inventory" page
    When user select "CP 24 Wells" in dropdown "Labware"
