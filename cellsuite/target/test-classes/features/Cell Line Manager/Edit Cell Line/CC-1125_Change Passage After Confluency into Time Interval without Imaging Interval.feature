...
Feature: CC-1125_Change Passage After Confluency into Time Interval without Imaging Interval
    ...
    And "my cell 3.0 edit" items is "already" exist
    ...
    When user "change" "my cell 3.1.0 edit" in "name" textbox
    ...
    When user clicks detail button of item "my cell 3.1.0 edit"
    ...
    | my cell 3.1.0 edit | Mouse | Embryo | Fibroblast | mimic human liver | sample cell from mouse liver | 78 hour(s) | DMEM FBS 10 | 100% | Trypsin | 600.0 µL | 15 minute(s) | 1 : 3 | 6 hour(s) | Yes | 48 hour(s) | 90000 x104 | 1 | 1 |
