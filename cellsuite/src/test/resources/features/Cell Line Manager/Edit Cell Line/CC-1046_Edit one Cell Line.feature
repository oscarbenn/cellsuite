...
Feature: CC-1046:Edit one Cell Line
    ...
    When user "change" "my cell 6.0 edit" in "name" textbox
    ...
    And user is navigated to "Cell Line" page
    When user clicks detail button of item "my cell 6.0 edit"
    ...
    | my cell 6.0 edit | Mouse | Embryo | Fibroblast | mimic human liver | sample cell from mouse liver | 80% Confluency | DMEM FBS 10 | 100% | Trypsin | 600.0 µL | 15 minute(s) | 1 : 3 | 6 hour(s) | Yes | 48 hour(s) | 90000 x104 | 1 | 1 |