...
Feature: CC-1119:Change from Time Interval (with Imaging Interval) to Confluency
    ...
    And "my cell 7" items is "already" exist


    Scenario: Edit
    When user select an item "my cell 7" by check the checkbox
    Then item "my cell 7" is checked
    And icon "edit" is enabled in page
    When user clicks on "edit" icon
    Then user is navigated to "Edit Cell Lines" page
    When user "change" "my cell 7.0 edit" in "name" textbox
    ...
    When user clicks detail button of item "my cell 7.0 edit"
    ...
    | my cell 7.0 edit | Mouse | Embryo | Fibroblast | mimic human liver | sample cell from mouse liver | 80% Confluency | DMEM FBS 10 | 100% | Trypsin | 600.0 µL | 15 minute(s) | 1 : 3 | 6 hour(s) | Yes | 48 hour(s) | 90000 x104 | 1 | 1 |
