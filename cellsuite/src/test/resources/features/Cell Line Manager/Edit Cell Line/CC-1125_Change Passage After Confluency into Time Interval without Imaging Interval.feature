@cellline
@CC-1125_Change_Passage_After_Confluency_into_Time_Interval_without_Imaging_Interval
Feature: CC-1125_Change Passage After Confluency into Time Interval without Imaging Interval
    ...
    And "my cell 8.0 edit" items is "already" exist

    Scenario: Edit
    When user select an item "my cell 8.0 edit" by check the checkbox
    Then item "my cell 8.0 edit" is checked
    And icon "edit" is enabled in page
    When user clicks on "edit" icon
    Then user is navigated to "Edit Cell Lines" page
    When user "change" "my cell 8.1 edit" in "name" textbox
    ...
    When user clicks to uncheck on "Imaging Interval" checkbox
    ...
    When user clicks detail button of item "my cell 8.1 edit"
    ...
    | my cell 8.1 edit | Mouse | Embryo | Fibroblast | mimic human liver | sample cell from mouse liver | 78 hour(s) | DMEM FBS 10 | 100% | Trypsin | 600.0 µL | 15 minute(s) | 1 : 3 | 6 hour(s) | Yes | 48 hour(s) | 90000 x104 | 1 | 1 |
