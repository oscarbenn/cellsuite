...
Feature: CC-1042: prekondisi
    ...
    When user "type" "my cell 6" in "name" textbox
    Then textbox "name" will fill by "my cell 6"
    ...
    When user clicks on "Create" button
    Then user is navigated to "Create Cell Lines" page
    When user "type" "my cell 7" in "name" textbox
    Then textbox "name" will fill by "my cell 7"
    When user fill textbox "organism" as "Mouse"
    Then textbox "organism" filled by "Mouse"
    When user fill textbox "tissue" as "Embryo"
    Then textbox "tissue" filled by "Embryo"
    ...
    When user "type" "my cell 8" in "name" textbox
    Then textbox "name" will fill by "my cell 8"
    When user fill textbox "organism" as "Mouse"
    Then textbox "organism" filled by "Mouse"
    When user fill textbox "tissue" as "Embryo"
    Then textbox "tissue" filled by "Embryo"
